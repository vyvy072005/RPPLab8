# Generated by Django 4.2.21 on 2025-05-07 18:05
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reason', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='hospital.reasonforvisit')),
            ],
        ),
        migrations.CreateModel(
            name='PatientStudy',
            fields=[
                ...
                ('patient', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='hospital.patient')),
                ('study', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='hospital.study')),
            ],
        ),
        migrations.CreateModel(
            name='MedicalCard',
